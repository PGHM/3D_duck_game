...
final boolean SOUNDS = true;

// if you wan't to explore the place without fear of being killed, this is your boolean to falsify
final boolean SKULL_ENABLED = true;

/* containers */
CopyOnWriteArrayList<Bomb> projectiles = new CopyOnWriteArrayList<Bomb>();
...
public void setup() {
  ...
  duckModel = new OBJModel(this, "duck_.obj", QUADS);
  duckModel.scale(1);
  ...
  OBJModel skullModel = new OBJModel(this, "skull.obj", QUADS);
  skullModel.scale(3.5f);
  skull = new Skull(skullStartX, 10, skullStartZ, -HALF_PI, skullSpeed, skullModel, this);
  ...
  makeWallsForTextures(roomSize, roomTileSize, new boolean[] { 
...
void scene() {
  ...
  pushMatrix();
  translate(0, 0, 0);
  textureCubeWithDoors(lava, wall, stars2, roomSize, roomTileSize, new boolean[] { 
    true, true, false, false
  }
  );
  popMatrix();
  pushMatrix();
  translate(50.1f, 0, 0);
  textureCubeWithDoors(grass, wood, leaf, roomSize, roomTileSize, new boolean[] { 
    true, false, false, true
  }
  );
  popMatrix();
  pushMatrix();
  translate(0, 0, -50.1f);
  textureCubeWithDoors(snow, water, ice, roomSize, roomTileSize, new boolean[] { 
    false, true, true, false
  }
  );
  popMatrix();
  ...
  textureCubeWithDoors(lava2, desert, wall, roomSize, roomTileSize, new boolean[] { 
    false, false, true, true
  }
  );
  popMatrix();
...
class Skull extends FloatingObject {
  ...
  public Skull(float x, float y, float z, float facing, float speed, OBJModel skullModel, PApplet parent) {
    super(x, y, z, facing, speed, skullModel);
  ...
  public void shoot() {
    ...
    OBJModel bomb = new OBJModel(parent, "Grenade.obj", QUADS);
    bomb.scale(0.15f);
